...
public class TBConfiguredFeatures {
    public static final AlterGroundTreeDecorator ALTER_GROUND = new AlterGroundTreeDecorator(new SimpleBlockStateProvider(TBBlocks.HELL_STONE.getDefaultState()));
