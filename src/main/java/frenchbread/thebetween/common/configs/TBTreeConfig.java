package frenchbread.thebetween.common.configs;
...
public class TBTreeConfig implements IFeatureConfig {
    public static final Codec<TBTreeConfig> CODEC = RecordCodecBuilder.create((builder) -> {
        ...
        })).apply(builder, TBTreeConfig::new);
    });
    ...
    protected TBTreeConfig(BlockStateProvider trunkProvider, BlockStateProvider leavesProvider, FoliagePlacer foliagePlacer, AbstractTrunkPlacer trunkPlacer, AbstractFeatureSizeType minimumSize, List<TreeDecorator> decorators, int maxWaterDepth, boolean ignoreVines, Heightmap.Type heightmap) {
    ...
    public TBTreeConfig copy(List<TreeDecorator> decorators) {
        return new TBTreeConfig(this.trunkProvider, this.leavesProvider, this.foliagePlacer, this.trunkPlacer, this.minimumSize, decorators, this.maxWaterDepth, this.ignoreVines, this.heightmap);
    }
    ...
    public static class Builder {
        ...
        public TBTreeConfig.Builder setDecorators(List<TreeDecorator> decorators) {
            this.decorators = decorators;
            return this;
        }

        public TBTreeConfig.Builder setMaxWaterDepth(int maxWaterDepth) {
            this.maxWaterDepth = maxWaterDepth;
            return this;
        }

        public TBTreeConfig.Builder setIgnoreVines() {
            this.ignoreVines = true;
            return this;
        }

        public TBTreeConfig.Builder setHeightmap(Heightmap.Type heightmap) {
            this.heightmap = heightmap;
            return this;
        }

        public TBTreeConfig build() {
            return new TBTreeConfig(this.trunkProvider, this.leavesProvider, this.foliagePlacer, this.trunkPlacer, this.minimumSize, this.decorators, this.maxWaterDepth, this.ignoreVines, this.heightmap);
        }
    }
}